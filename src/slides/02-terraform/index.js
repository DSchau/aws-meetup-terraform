...
export const TfIntro = () => (
  <Heading size={2} caps fit>Terraform is&hellip;</Heading>
);
...
export const CodeExample = () => (
  <Layout>
    <Fill>
      <CodePane lang="json" source={require('./assets/ec2.cloudformation').default} />
    </Fill>
    <Fill>
      <CodePane lang="js" source={require('./assets/ec2.tf').default} style={{ marginLeft: 20 }}/>
    </Fill>
  </Layout>
);
...
export const PlanExample = () => (
  <Image src={require('./assets/tfplan.png')} />
);
